...
const changelog = computed(() => {
	const flavoredString = (release[type.value].body ?? "")
		...
		.replace("https://github.com/kaajjo/libre-sudoku/releases", "/changelogs/")
...
<template>
	...
	<div class="fullChangelog">
		<p>
			...
			<a href="https://github.com/kaajjo/libre-sudoku/releases/latest" target="_blank" rel="noopener">
				here
			</a>
		</p>
	</div>
