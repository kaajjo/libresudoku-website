...
hero:
  name: LibreSudoku
  text: Powerful sudoku app for android
  tagline: Open source sudoku app with many features and customizations
  image:
    alt: LibreSudoku GameScreen
...
customMetaTitle: LibreSUdoku

features:
  - title: Import and Export
    details: Import or export your sudoku, create backups and more
    ...
    link: /extensions/
    linkText: Export and backups
  - title: Customization
    details: Make it yours with many customizations, such as a dynamic color scheme, mistakes checking type, date format and more
    icon: <svg height="24" width="24" viewBox="0 -960 960 960" fill="var(--vp-c-indigo-2)" xmlns="http://www.w3.org/2000/svg"><path d="M440-120v-240h80v80h320v80H520v80h-80Zm-320-80v-80h240v80H120Zm160-160v-80H120v-80h160v-80h80v240h-80Zm160-80v-80h400v80H440Zm160-160v-240h80v80h160v80H680v80h-80Zm-480-80v-80h400v80H120Z"/></svg>
    link: /docs/guides/getting-started
    linkText: See settings
    
  - title: 6x6, 9x9, 12x12
    details: Play an infinie number of 6x6, 9x9 and 12x12 puzzles with 4 difficulties that are graded using human solution methods.
